<?php
$connect = mysqli_connect("localhost:3308","root","","modul3");
if(isset($_GET['id_mobil'])){
    mysqli_query($connect, "DELETE from modul3 where id_mobil='$_GET[id_mobil]'");
...
<table border="1.5">
    ...
    $ambildata = mysqli_query($connect, "SELECT * from modul3");
