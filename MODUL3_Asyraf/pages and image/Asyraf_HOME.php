...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="na\vbarNavAltMarkup">
                <div class="navbar-nav mx-left">
                    <a class="nav-link text-light" href="Asyraf_HOME">Home</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <br><br><img src="logo-ead.png"  style="width: 100px;px;height: 25px;px;"><a> Asyraf_1202204012</a>
            </div>
            </div> 
            <div class="col">
                <img src="gambar1.png" style="width:600px;height:380px;">
            </div>  
        </div>
    </div>
    </div>
