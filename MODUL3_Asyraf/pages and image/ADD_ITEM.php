...
<html lang="en">
  ...
  <body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="na\vbarNavAltMarkup">
                <div class="navbar-nav mx-left">
                    <a class="nav-link text-light" href="Asyraf_HOME.PHP">Home</a>
    ...
    <div class="container"> 2
        ...
        <h6 class="mb ">Tambah Mobil Baru Anda Ke List Show Room </h6><br>
		<form action="index.php" method="POST">
			...
			<div class="mb ">
				...
				<input type="text" class="form-control" name="pemilik_mobil" value="Asyraf_1202204012" readonly>
			</div>
            <div class="mb ">
