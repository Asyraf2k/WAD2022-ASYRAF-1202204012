...
<ul class="nav justify-content-center navbg">
  ...
  <div class="row g-0">
    <div class="col-md-6">
      <br><br><br><br>
        <?php
        if (array_key_exists("Brio", $_POST)) {
            echo '<img src="brio.png" class="img-fluid rounded-start" alt="...">';
        } elseif (array_key_exists("Ertiga", $_POST)) {
            echo '<img src="ertiga.png" class="img-fluid rounded-start" alt="...">';
        } elseif (array_key_exists("agya", $_POST)) {
            echo '<img src="agya.png" class="img-fluid rounded-start" alt="...">';
        } else {
            echo '<img src="agya.png" class="img-fluid rounded-start" alt="...">';
        }
        ?>
    ...
    <!-- <form action="Hasil.php" method="GET"> -->
        ...
        <div class= "mb-3">
                ...
                <select class="form-control" name="car" id="">
                    ...
                    <option value="Toyota Rush">HRV</option>
                    <option value="Toyota Ayla">Fortuner</option>
                    <option value="Honda Brio">Pajero</option>
                </select>
        </div>
        <div class= "mb-3">
        ...
        <br>
            ...
            <div class="mb-3">
        <button type="submit" class="btn btn-success btn btn-primary btn-lg btn-block" href="#" height>Book</button>
    </form>
</div>
